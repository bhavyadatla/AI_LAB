while True:
    user_input = input("Enter the n value for n*n Board (<=25): ")
    try:
        n = int(user_input)
        if n <= 0:
            ...
            print("Not possible. N-queen problem is only solvable for n > 3 (except n=1).")
            continue
        elif n > 25:
            print("n value should be less than 25:")
            continue
        break  
    except ValueError:
